...
public class GameLoggerDatabaseOld extends SQLiteOpenHelper {

    private static final String LOG_TAG = GameLoggerDatabaseOld.class.getSimpleName();
...
//        String WIN_TYPE = "wintype";
  ...
  public GameLoggerDatabaseOld(Context contextIn){
