...
public class DatabaseModel {
    ...
    public void updateLoggedGame(LoggedGameOverview lgo, LoggedGamePlayer playerOne, LoggedGamePlayer playerTwo) {
    ...
    private Integer getLoggedGamePlayer(Integer gameId, Integer player_id, String side) {
        LoggedGamePlayer ret = storIOSQLite
                ...
                .withQuery(Query.builder()
                        ...
                        .where(LoggedGamePlayer.LoggedGamePlayersColumns.GAME_ID + " = ? AND " + LoggedGamePlayer.LoggedGamePlayersColumns.PLAYER_ID + " = ? and " + LoggedGamePlayer.LoggedGamePlayersColumns.PLAYER_SIDE + " = ?")
                        .whereArgs(gameId, player_id, side)
                        .build())
                .prepare()
                .executeAsBlocking();

        Log.d(LOG_TAG, "getLoggedGamePlayer: Gamid = " + gameId + " | Player_ID = " + player_id + " | Side = " + side);
